import {
  ...
  GoabRadioGroup,
  GoabRadioItem,
  GoabButton, GoabCheckbox, GoabModal,
...
export function LowCustomHighDebtRoute() {
  ...
  return (
    <div className="low-custom-high-debt-debt" style={{ padding: "7px 11px 30px 9px" }}>
      <div style={{ fontSize: "31px", lineHeight: "34px", fontWeight: 500, marginBottom: "8px" }}>Submit your form</div>
      <div style={{ fontSize: "17px", lineHeight: "23px", marginBottom: "18px" }}>
      ...
      {state.moreInput &&
        <div style={{ border: "1px solid #d1d1d1", borderTop: "6px solid #0081a5", padding: "13px", marginBottom: "25px", background: "#fff" }}>
            <div style={{display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "9px"}}>
              <div style={{ fontSize: "22px", lineHeight: "28px", margin: 0 }}>This is an interactive container</div>
              <div style={{ color: "#005e8e", cursor: "pointer", textDecoration: "underline" }} onClick={showSaveConfirmationModal}>Remove container</div>
            </div>
          <div style={{ marginBottom: "11px", fontSize: "14px", lineHeight: "20px" }}>
          ...
          <div style={{ fontSize: "14px", marginBottom: "4px" }}>Do you want to show another type of input?</div>
          <div style={{ fontSize: "12px", color: "#555", marginBottom: "6px" }}>You can select multiple items on this list.</div>
            {Items.map(item => 
              <GoabCheckbox
                key={item}
                name="items"
